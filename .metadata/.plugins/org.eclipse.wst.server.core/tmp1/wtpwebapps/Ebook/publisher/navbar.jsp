...
<c:if test="${not empty puserobj}">
 ...
 <i class="fas fa-user"></i>${ puserobj.pname }</a>
...
<a href="../PLogin.jsp" class="btn btn-success"><i class="fas fa-sign-in-alt"></i>
Login</a>

<a href="../RegPublisher.jsp" class="btn btn-primary text-white"><i class="fa fa-registered" aria-hidden="true"></i>Register</a>
</c:if>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="psetting.jsp">Home <span class="sr-only">(current)</span></a>
         
      </li>
      <li class="nav-item active">
      <a class="nav-link" href="psetting.jsp">Profile <span class="sr-only">(current)</span></a>
      </li>
